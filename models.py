...
class Certifications(models.Model):
    ...
    valid_period = models.TextField(blank=True, null=True)
    resume = models.ForeignKey('Resume', models.DO_NOTHING, blank=True, null=True)
...
class Internships(models.Model):
    intership_id = models.AutoField(primary_key=True)
    name_of_role = models.TextField(blank=True, null=True)
...
class PersonalDetails(models.Model):
    ...
    extracircular_activities = models.TextField(blank=True, null=True)
...
class Qualifications(models.Model):
    ...
    school_or_college = models.TextField()
    board_or_university = models.TextField()
    cgpa_or_percentage = models.DecimalField(max_digits=5, decimal_places=2)
    resume = models.ForeignKey('Resume', models.DO_NOTHING, blank=True, null=True)
...
class Resume(models.Model):
    ...
    person = models.ForeignKey(PersonalDetails, models.DO_NOTHING, blank=True, null=True)
